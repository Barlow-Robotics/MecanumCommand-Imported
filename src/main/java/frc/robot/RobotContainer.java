...
public class RobotContainer {
    ...
    private void configureButtonBindings() {
        ...
        if (controllerType.equals("RadioMas TX16S Joystick")) {
            ...
            liftToIntakeButton = new JoystickAnalogButton(m_driverController, Constants.RadioMaster_Controller.SB3_Axis, 0.0, 0.25 );
            //liftToIntakeButton = new JoystickButton(m_driverController, 10 );
