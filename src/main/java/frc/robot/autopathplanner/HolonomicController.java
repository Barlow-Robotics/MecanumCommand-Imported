...
public class HolonomicController {
  ...
  public ChassisSpeeds calculate(
    ...
    */
    ...
    count++;
    // Return next output.
    return edu.wpi.first.math.kinematics.ChassisSpeeds.fromFieldRelativeSpeeds(
  ...
  public edu.wpi.first.math.kinematics.ChassisSpeeds calculate(
      edu.wpi.first.math.geometry.Pose2d currentPose, edu.wpi.first.math.trajectory.Trajectory.State desiredState, edu.wpi.first.math.geometry.Rotation2d angleRef, edu.wpi.first.math.trajectory.Trajectory.State absoluteHeading) {
    return calculate(
